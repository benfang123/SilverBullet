<template>
	<div class="Main-bottom-plate" :style='{filter:"brightness("+$store.getters.luminance+")"}'>
		<!-- 展示登录页面用的 -->
		<router-view v-show="!isLogin()" class="app-login"></router-view>
		<div id="app" >
		  <!-- 左侧导航栏 -->
		  <div id="tab" v-show='isLogin()'>
		    <!-- Logo -->
		    <div class="logo-box">
...
export default {
  ...
  methods: {
    ...
    changeThemes(theme) {
      ...
      this.$store.commit("changeTheme", theme);//更新vuex颜色进行同步
    },
