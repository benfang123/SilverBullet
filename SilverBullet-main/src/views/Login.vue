<template>
	<div class="box">
	        <div class="content">
				<SignIn v-show="this.$route.path!=='/Login/signup'">
					<div class="divider">
					...
					<div class="other-login-wrapper">
					    <div class="other-login-item">
					        <img src="@/assets/icons/QQ.png" alt="">
					    </div>
					    <div class="other-login-item">
	...
	* {
	...
	@media (min-width: 767px) {
	  ...
	  .box .content {
	    width: 85vw;
	    height: 90vh;
	    background: url("../assets/icons/login_two.jpg") no-repeat;
	...
	@media (max-width: 768px) {
	  ...
	  .box .content {
	    width: 100vw;
	    height: 100vh;
	    background: url("../assets/icons/login_bg_phone.png") no-repeat;
